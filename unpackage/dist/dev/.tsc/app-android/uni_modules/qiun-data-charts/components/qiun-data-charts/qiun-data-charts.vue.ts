...
const __sfc__ = defineComponent({
  ...
  methods: {
    ...
    localdataInit(resdata){
      ...
      let tmpData = {__$originalPosition: new UTSSourceMapPosition("tmpData", "uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue", 679, 11),categories:[], series:[]}
      let tmpcategories = []
      let tmpseries = [];
      //拼接categories
      if(this.echarts === true){
      ...
      if(needCategories === true){
        ...
        if(this.chartData && this.chartData.categories && this.chartData.categories.length>0){
          ...
          //否则从结果中去重并拼接categories
            ...
            let tempckey = {__$originalPosition: new UTSSourceMapPosition("tempckey", "uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue", 704, 17),};
      ...
      //拼接series
      let tempskey = {__$originalPosition: new UTSSourceMapPosition("tempskey", "uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue", 716, 11),};
      resdata.map(function(item, index) {
