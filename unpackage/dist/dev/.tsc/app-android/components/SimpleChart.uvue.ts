...
const __sfc__ = defineComponent({
  ...
  props: {
    ...
    colors: {
      type: Array,
      default: () => ['#007AFF', '#34C759', '#FF9500', '#FF3B30', '#AF52DE']
    },
    showLegend: {
      type: Boolean,
      default: true
