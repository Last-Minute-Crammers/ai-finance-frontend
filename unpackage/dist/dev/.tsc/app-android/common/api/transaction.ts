...
export const getTransactionList = (params: TransactionListParams = {}): Promise<ApiResponse<TransactionListResponse>> => {
  __f__('log','at common/api/transaction.ts:40','getTransactionList called with params:', params);
...
export const createTransaction = (data: {
  ...
  __f__('log','at common/api/transaction.ts:58','createTransaction called with data:', data);
