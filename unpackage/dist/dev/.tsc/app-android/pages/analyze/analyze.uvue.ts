...
// 图表颜色配置
const chartColors = {__$originalPosition: new UTSSourceMapPosition("chartColors", "pages/analyze/analyze.uvue", 108, 7),
  bar: ["#91CB74", "#EE6666"],
...
async function loadCategoryData() {
  try {
    ...
    console.log('交易列表响应类型:', typeof response, " at pages/analyze/analyze.uvue:375")
    ...
    // 检查 Data 字段的结构
    if (response.Data) {
      console.log('Data 字段类型:', typeof response.Data, " at pages/analyze/analyze.uvue:385")
