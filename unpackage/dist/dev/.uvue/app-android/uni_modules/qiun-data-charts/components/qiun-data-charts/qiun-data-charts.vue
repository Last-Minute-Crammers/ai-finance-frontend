...
const __sfc__ = defineComponent({
    ...
    watch: {
        ...
        mixinDatacomErrorMessage(val, oldval) {
            if (val) {
                ...
                if (this.errorShow) {
                    console.log('[秋云图表组件]' + val, " at uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue:611");
                }
            }
        },
    ...
    computed: {
        optsProps(): any {
            return UTSAndroid.consoleDebugError(JSON.parse(JSON.stringify(this.opts)), " at uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue:629");
        },
        eoptsProps(): any {
            return UTSAndroid.consoleDebugError(JSON.parse(JSON.stringify(this.eopts)), " at uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue:632");
        },
        chartDataProps(): any {
            return UTSAndroid.consoleDebugError(JSON.parse(JSON.stringify(this.chartData)), " at uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue:635");
        },
    },
    methods: {
        beforeInit() {
        ...
        localdataInit(resdata) {
            ...
            let tmpData = { __$originalPosition: new UTSSourceMapPosition("tmpData", "uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue", 679, 11), categories: [], series: [] } as UTSJSONObject;
            let tmpcategories = [];
            let tmpseries = [];
            //拼接categories
            if (this.echarts === true) {
            ...
            if (needCategories === true) {
                ...
                if (this.chartData && this.chartData.categories && this.chartData.categories.length > 0) {
                    ...
                    if (this.startDate && this.endDate) {
                        ...
                        let tempckey = { __$originalPosition: new UTSSourceMapPosition("tempckey", "uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue", 704, 17), } as UTSJSONObject;
            ...
            //拼接series
            let tempskey = { __$originalPosition: new UTSSourceMapPosition("tempskey", "uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue", 716, 11), } as UTSJSONObject;
            resdata.map(function (item, index) {
...
//# sourceMappingURL=qiun-data-charts.vue.map